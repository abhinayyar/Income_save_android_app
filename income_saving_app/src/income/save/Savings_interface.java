...
public class Savings_interface extends Activity {
			...
			public void onClick(View v) {
				...
				if((a=='2')&&(b=='0')){
					...
					Intent goToNextActivity = new Intent(
							getApplicationContext(), enter_saving.class);
					startActivity(goToNextActivity);
				}
				else
				{
					Toast.makeText(Savings_interface.this, "Date format incorrect enter in form like 20..", Toast.LENGTH_LONG).show();
				}
